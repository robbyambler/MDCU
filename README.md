# Matt Damon Cinematic Universe (MDCU)

This repo collects a tongue-in-cheek but internally consistent "Matt Damon Cinematic Universe" (MDCU), where many of Matt Damon's major film roles are treated as different aliases of a single individual. One human relationship runs through the entire arc: the friend from South Boston (Ben Affleck) who knew him before any of the identities began.

## Files

- `mdcu-overview.md` – Universe rules and full life arc with connective tissue between eras.
- `mdcu-timeline.md` – Detailed personal chronology table.
- `mdcu-diagram.md` – Mermaid flowchart source for the MDCU.
- `mdcu.html` – Rendered dossier page with tabbed navigation: Life Arc, Timeline, Filmography, and Universe Rules. Open locally in any browser.

## Canonical arc (lived identities, in chronological order)

| # | Film | Alias | Note |
|---|------|-------|------|
| 1 | Good Will Hunting | Will Hunting | Origin; meets Chuckie (Ben Affleck) |
...
- *Stuck on You* — conjoined twins; the most emotionally honest thing in the catalog
...
GitHub renders Mermaid diagrams automatically in Markdown files fenced with a `mermaid` code block. View `mdcu-diagram.md` on GitHub to see it render. Alternatively, paste the Mermaid block into any online Mermaid editor.

---

## Disclaimer

This project is an unofficial, non-commercial fan work created for entertainment and creative purposes only. It is not affiliated with, endorsed by, or connected to Matt Damon, any of the studios, production companies, or rights holders associated with the films referenced herein.

All film titles, characters, and related intellectual property referenced in this project are the property of their respective owners, including but not limited to:

- *Good Will Hunting* © 1997 Miramax Films / Be Gentlemen Limited Partnership
- *Invictus* © 2009 Warner Bros. Entertainment Inc.
- *Rounders* © 1998 Miramax Films
- *The Rainmaker* © 1997 Constellation Entertainment / American Zoetrope
- *Courage Under Fire* © 1996 Twentieth Century Fox Film Corporation
...
- *Interstellar* © 2014 Warner Bros. Entertainment Inc. / Paramount Pictures
- *Elysium* © 2013 TriStar Pictures / Media Rights Capital
- *The Great Wall* © 2016 Universal Pictures / Legendary Entertainment
- *Saving Private Ryan* © 1998 DreamWorks Pictures / Paramount Pictures
- *Dogma* © 1999 Lions Gate Films
- *The Talented Mr. Ripley* © 1999 Paramount Pictures / Miramax Films
- *All the Pretty Horses* © 2000 Columbia Pictures
- *Stuck on You* © 2003 Twentieth Century Fox Film Corporation
- *Suburbicon* © 2017 Paramount Pictures
- *The Last Duel* © 2021 Twentieth Century Studios
- *Thor: Love and Thunder* © 2022 Marvel Studios / Walt Disney Pictures
- *Ocean's Eleven*, *Ocean's Twelve*, *Ocean's Thirteen* © Warner Bros. Entertainment Inc.
- *Stillwater* © 2021 Focus Features
